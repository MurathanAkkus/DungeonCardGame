...
public abstract class PerkCondition
{
    ...
    public abstract bool SubConditionMet(GameAction action);                // Alt koþulun karþýlanýp karþýlanmadýðýný kontrol eder, yani perk'in tetiklenmesi için gerekli þartlarýn saðlanýp saðlanmadýðýný belirler
}
