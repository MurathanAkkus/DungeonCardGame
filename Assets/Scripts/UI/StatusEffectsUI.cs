...
public class StatusEffectsUI : MonoBehaviour
{
    ...
    public void UpdateStatusEffectUI(StatusEffectType statusEffectType, int stackCount, int magnitude, int duration)
    {
        // var olan alt yapını koru; sadece text biçimini zenginleştir.
        // Örn:
        // BURN      : $"Burn {magnitude} (⏳{(duration<0 ? '∞' : duration)})"
        // STRENGTH  : $"Str +{magnitude}"
        // TEMP_STR  : $"Temp +{magnitude} (⏳{duration})"
